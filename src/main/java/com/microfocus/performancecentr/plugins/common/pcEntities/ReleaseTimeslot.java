...
import com.microfocus.performancecentr.plugins.common.rest.PcRestProxy;
...
public class ReleaseTimeslot {
	...
	public String objectToXML() {
		...
		obj.alias("PostRunActions", com.microfocus.performancecentr.plugins.common.pcEntities.ReleaseTimeslot.class);
		obj.useAttributeFor(com.microfocus.performancecentr.plugins.common.pcEntities.ReleaseTimeslot.class, "xmlns");
