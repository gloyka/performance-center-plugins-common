...
public class TrendReportTransactionDataRows {
    ...
    public TrendReportTransactionDataRows() {
        trendReportTransactionDataRowList = new ArrayList<TrendReportTransactionDataRow>();
    }
    ...
    public void setTrendReportTransactionDataRowList(ArrayList<TrendReportTransactionDataRow> trendReportTransactionDataRowList) {
        this.trendReportTransactionDataRowList = trendReportTransactionDataRowList;
    }
}
