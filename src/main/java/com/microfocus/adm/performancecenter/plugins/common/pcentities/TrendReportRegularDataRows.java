...
public class TrendReportRegularDataRows {
    ...
    public TrendReportRegularDataRows() {
        trendReportRegularDataRowList = new ArrayList<TrendReportRegularDataRow>();
    }
    ...
    public void setTrendReportRegularDataRowList(ArrayList<TrendReportRegularDataRow> trendReportRegularDataRowList) {
        this.trendReportRegularDataRowList = trendReportRegularDataRowList;
    }
}
