...
public class ReleaseTimeslot {
	...
	public String objectToXML() {
		...
		obj.alias("PostRunActions", com.performancecentr.plugins.common.pcEntities.ReleaseTimeslot.class);
		obj.useAttributeFor(com.performancecentr.plugins.common.pcEntities.ReleaseTimeslot.class, "xmlns");
